...
% Title.
% ------
\title{libspatdif - Implementing the Spatial Sound Descriptor Interchange Format}
...
\lstinputlisting[columns=fullflexible,breaklines=true,numbers=none,basicstyle=\scriptsize\ttfamily]{turenas-insect-extract.xml} 
...
\lstinputlisting[columns=fullflexible,breaklines=true,numbers=none,basicstyle=\scriptsize\ttfamily]{example_code2.cpp} 

\noindent This produces the folloing std-output: 
