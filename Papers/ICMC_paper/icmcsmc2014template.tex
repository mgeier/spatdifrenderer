...
% TODO: Check grammar in the following line.
...
% COMMENT: I find the layout below somewhat messy. IMHO it would be better to use subsubsections. I'm also asking myself if the above paragraph should be shorter, so that we do not embark into a discussion of how classes and instances relate until we have presented them one by one.
...
% COMMWENT: This reads as bulleted lists without the bullets, it would be better to make this sentences with proper grammar.
