...
These commands form a loop that steps through the scene, which is made apparent in the figure with the orange connection flowing back to the spatdif-external.
